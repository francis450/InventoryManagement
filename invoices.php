...
<!--Wet Stock - Forecourt Sales   -->
        ...
        <div class="panel panel-default">
         ...
         <div class="panel-body">
            ...
            <?php $payment = mysqli_query($con, "SELECT SUM(amountgiven) as total FROM invoices where transactiontype = 'cash' and date(timed) = curdate()");  $cash = mysqli_fetch_array($payment); ?>
             ...
             <p><div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                      <div class="panel-heading">
                          <?php
                          $d = date('Y');
                                        $grts = mysqli_query($con,"select SUM(total) as amount from cart WHERE YEAR(dated) = YEAR(CURDATE())");
                                        $grtsrs= mysqli_fetch_array($grts);
                                        $df= $grtsrs['amount'];
                                        echo 'Total Sales = Ksh '.number_format($df,2);
                          ?>
